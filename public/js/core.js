...
(function () {
    ...
    const GAME_FALLBACK = [
        { id: 'efootball', short: 'eFootball', icon: '⚽', accent: '#0FB5A9' },
        { id: 'mlbb', short: 'Mobile Legends', icon: '🛡️', accent: '#7C5CFF' },
        { id: 'pubg', short: 'PUBG Mobile', icon: '🎯', accent: '#F2A017' },
        { id: 'freefire', short: 'Free Fire', icon: '🔥', accent: '#F03E55' },
    ];
    ...
    const ICONS = {
        ...
        rotate: '<svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2.1" stroke-linecap="round" stroke-linejoin="round"><path d="M20 11A8 8 0 1 0 18.5 16.5"/><path d="M20 5v6h-6"/></svg>',
